 ...
 */
public abstract class BaseRequestHandler implements RestHandler {
    ...
    public
    Map<String, RequestBinding>  initDefaultHandlers(final String serviceName) {

        ClassMeta meta = ClassMeta.classMeta(this.getClass());
