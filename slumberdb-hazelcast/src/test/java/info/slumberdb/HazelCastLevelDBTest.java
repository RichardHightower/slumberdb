 ...
 */
public class HazelCastLevelDBTest {


    static private Map<String, Employee> store;
    ...
    static {
        ...
        mapStoreCfg.setImplementation(new HazelCastLevelDBJSONMapStore("./target/emp-leveldb.dat", Employee.class));
